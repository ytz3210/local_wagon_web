...
// 车队信息页面 (条件)
const queryAllDrivers = (params) => getAction('/api/all_drivers', params)
// 车队信息页面 (条件)
const queryAllWagonTeam = (params) => getAction('/api/all_wagon_teams', params)
// 增加车辆信息
const addWagon = (params) => putAction('/api/wagon', params)
// 修改车辆信息
const editWagon = (params) => postAction('/api/wagon', params)
// 删除车辆信息
const delWagon = (params) => deleteAction('/api/wagon', params)
// 导出批量导入车辆excel模板
const wagonsExport = (params) => getAction('/api/wagons/export', params)
// 导入车辆信息管理excel
const wagonsImport = (params) => postAction('/api/wagons/import', params)

// 车辆监控
const getWagonOnMission = (params) => getAction('/api/monitor/wagon', params)
//监控大屏
const getMonitorLSD = (params) => getAction('/api/monitor/mission_lsd/0',params)
// 忽略告警事件
const ignoreWarningEvent = (params) => deleteAction('/api/monitor/ignore', params)
